...
Object(_wordpress_blocks__WEBPACK_IMPORTED_MODULE_1__["registerBlockType"])('pg/basic', {
  ...
  save: function save() {
    return null;
  } //PHP se encargará del renderizado dinamico    

});
Object(_wordpress_blocks__WEBPACK_IMPORTED_MODULE_1__["registerBlockType"])('pg/table-block', {
  ...
  attributes: {
    content: {
      type: 'string',
      default: [{
        title: 'M1 sera una sorpresa',
        description: 'Intro al nuevo procesador de Apple'
      }, {
        title: 'Top 10 sitios web en JS',
        description: 'Sitios web al que todo desarrollador deberia entrar cada dia'
      }]
    }
  },
  edit: function edit(props) {
    ...
    return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("table", {
      ...
      scope: "col"
    }, "Titulo"), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("th", {
      scope: "col"
    }, "Descripci\xF3n"))), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("tbody", null, content.map(function (r, index) {
      return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("tr", null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("th", {
        scope: "row"
      }, index + 1), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("td", null, r.title), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("td", null, r.description));
    })));
  },
